...
if len(sys.argv)<2:
	...
	currcommands['add $note'] = 'run python data/libraries/notesLib.py add $note'
	...
	currcommands['show $note'] = 'run python data/libraries/notesLib.py show $note'
	currcommands['delete $note'] = 'run python data/libraries/notesLib.py delete $note'
	currcommands['add {note}'] = 'run python data/libraries/notesLib.py add {note}'
